...
>ADD CONSTRAINT TO LIMIT INSERTION ON SOME COLUMNS : 
...
```
>IF WE TRY TO ADD ANY RECORD THAT VIOLATES THE CONSTRAINT THEN : 
...
```
ALTER TABLE ARTIST DROP CONSTRAINT BANAGALI_CHECK;
```
